...
def get_openai_response(user_text: str, system_message: str) -> str:
    if client is None:
        return "OPENAI_API_KEY가 없습니다. .env 또는 시스템 환경변수에 OPENAI_API_KEY를 설정해줘."
    try:
...
def render_exchange_widget(
    ...
    """Popover 형태의 환율 계산기 위젯 렌더링 (개선 버전)"""
...
>>>>>>> 1ee75a4a58a9cae4540fdddd6560faa0f9b8418b
""", unsafe_allow_html=True)